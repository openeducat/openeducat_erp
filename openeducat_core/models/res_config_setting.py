...
class ResConfigSettings(models.TransientModel):
    ...
    module_openeducat_bigbluebutton = fields.Boolean(string="Bigbluebutton Enterprise")
    ...
    module_openeducat_fees_enterprise = fields.Boolean(string="Fees Enterprise")
    ...
    module_openeducat_online_admission = fields.Boolean(string="Online Admission Enterprise")
